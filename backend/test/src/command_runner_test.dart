...
import 'package:backend/src/command_runner.dart';
...
void main() {
  group('BackendCommandRunner', () {
    late PubUpdater pubUpdater;
    late Logger logger;
    late BackendCommandRunner commandRunner;
    ...
    test('can be instantiated without an explicit analytics/logger instance',
        () {
      final commandRunner = BackendCommandRunner();
