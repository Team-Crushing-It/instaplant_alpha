...
class Plant extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Plant', createEmptyInstance: create)
    ...
    ..aOM<SensorUpdate>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'current', subBuilder: SensorUpdate.create)
    ..pc<SensorUpdate>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'history', $pb.PbFieldType.PM, subBuilder: SensorUpdate.create)
    ..a<$core.int>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'daysTillHarvest', $pb.PbFieldType.O3, protoName: 'daysTillHarvest')
  ...
  factory Plant({
    ...
    if (daysTillHarvest != null) {
      _result.daysTillHarvest = daysTillHarvest;
    }
    return _result;
  }
  ...
  @$pb.TagNumber(3)
  SensorUpdate get current => $_getN(2);
  @$pb.TagNumber(3)
  set current(SensorUpdate v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasCurrent() => $_has(2);
  @$pb.TagNumber(3)
  void clearCurrent() => clearField(3);
  @$pb.TagNumber(3)
  SensorUpdate ensureCurrent() => $_ensure(2);

  @$pb.TagNumber(4)
  $core.List<SensorUpdate> get history => $_getList(3);

  @$pb.TagNumber(5)
  $core.int get daysTillHarvest => $_getIZ(4);
  @$pb.TagNumber(5)
  set daysTillHarvest($core.int v) { $_setSignedInt32(4, v); }
  @$pb.TagNumber(5)
  $core.bool hasDaysTillHarvest() => $_has(4);
  @$pb.TagNumber(5)
  void clearDaysTillHarvest() => clearField(5);
}
