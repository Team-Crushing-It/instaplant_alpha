...
import 'package:rpi/src/command_runner.dart';
...
void main() {
  group('RpiCommandRunner', () {
    late PubUpdater pubUpdater;
    late Logger logger;
    late RpiCommandRunner commandRunner;
    ...
    setUp(() {
      ...
      commandRunner = RpiCommandRunner(
        logger: logger,
    ...
    test('can be instantiated without an explicit analytics/logger instance',
        () {
      final commandRunner = RpiCommandRunner();
